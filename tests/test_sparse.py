...
class TestGilDetection:
    ...
    def test_is_gil_disabled_returns_bool(self):
        ...
        from et_miner.matrix import _is_gil_disabled
    ...
    def test_get_effective_workers(self):
        ...
        from et_miner.matrix import _get_effective_workers
        import os
...
class TestSparseMkl:
    ...
    def test_sparse_matmul_correctness(self):
        ...
        from et_miner.matrix import _sparse_matmul
...
class TestAdaptiveParallelConfig:
    ...
    def test_returns_required_keys(self):
        ...
        from et_miner.matrix import _get_adaptive_parallel_config
