...
from et_miner.gpu_dispatch import (
...
class TestShouldUseMultiGpu:
    ...
    @patch("et_miner.gpu_dispatch.get_gpu_count", return_value=4)
    ...
    @patch("et_miner.gpu_dispatch.get_gpu_count", return_value=1)
    ...
    @patch("et_miner.gpu_dispatch.get_gpu_count", return_value=0)
    ...
    @patch("et_miner.gpu_dispatch.get_gpu_count", return_value=2)
