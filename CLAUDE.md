...
- 2026-09-03: branch `v2` carries the V2 preprint of `paper/et_miner_proteome.tex`, which reports
  ONLY the fresh run on this box (single pinned RTX 3090 for the campaign and the SON comparison,
  two GPUs for the null model and the per-K exports). Zero H100 references; every number traces to
  RESULTS.md / COMPARISON_REPORT.md; `CHANGELOG_V1_V2.md` maps V1 → V2 value by value and lists what
  was flagged rather than removed. The V2 edit scripts are in `runs/20260902T0000Z/phase4/`.
